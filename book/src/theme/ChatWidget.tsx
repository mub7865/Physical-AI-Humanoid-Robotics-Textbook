...
import styles from './ChatWidget.module.css'; // Will create this CSS module
    ...
    <>
      ...
      {isOpen && (
        <div className={styles.chatWindow}>
          ...
          {selectedContext && (
            <div className={styles.contextBadge}>Context found: "{selectedContext.replace(/^Context found: "?/, '').substring(0, 50)}..."</div>
          )}
